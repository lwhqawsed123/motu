    ...
    <div class="record-conter">
      ...
      >
        ...
        <el-table-column prop="credittype" min-width="80" label="币种">
          <template
            slot-scope="scope"
          >{{myFilter(scope.row.credittype,creditTypeOptions)}}</template>
        </el-table-column>
