  ...
  <div class="record">
    <div class="record-conter">
      ...
      >
        ...
        <!-- <el-table-column prop="entrustNumber" label="公会" show-overflow-tooltip></el-table-column> -->
    ...
    >
      ...
      >
        ...
        <el-form-item label="绑定手机号" prop="mobile">
          <el-input v-model="ruleForm.mobile" maxlength="30" show-word-limit></el-input>
        </el-form-item>
