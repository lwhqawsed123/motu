    ...
    <el-container class="chatting-records" v-loading="loading">
      ...
      <div class="anchor-info">
        <el-popover placement="left" trigger="click">
          <anchor-message :anchorDetail="anchorForm"></anchor-message>
          ...
          <div ref="chatting-content">
            ...
            >
              ...
              <div
                ...
                :class="item.fromid===checkedUser.userid?'anchor-chatt-records':'visitor-chatt-records'"
              >
                <div class="profile-box">
                  <img :src="item.f_avatar" alt class="profile" />
                </div>
                <!-- 消息内容/普通自定义消息 -->
                ...
                <div
                  class="chatt-records-message"
                  v-else-if="item.msgtype==='CUSTOM'&&item.msgcontent.type===3"
                >
                  <span class="triangle-before"></span>
                  <span class="chatt-records-text">[动态表情]</span>
                </div>
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      loadTime: 500,
      anchorDetailLoading: false, // 左上角主播详情
    };
  },
