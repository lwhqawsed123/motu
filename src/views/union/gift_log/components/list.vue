  ...
  <div class="record">
    <div class="record-conter">
      ...
      >
        ...
        <el-table-column show-overflow-tooltip prop="group_name" label="公会" min-width="60px"></el-table-column>
        <!-- 发送者信息 -->
        <!-- 用户信息 -->
        <el-table-column label="送出" show-overflow-tooltip min-width="50px">
          <template slot-scope="scope">
           <info-popover :userid="scope.row.send" :avatar="scope.row.f_avatar"></info-popover>
          </template>
        </el-table-column>
        <el-table-column show-overflow-tooltip min-width="120px" label="昵称/ID">
          <template slot-scope="scope">
            ...
            <span title="用户ID">{{scope.row.send}}</span>
          </template>
           <!-- <template slot-scope="scope">
        ...
        <!-- 接收者信息 -->
        <!-- 用户信息 -->
        <el-table-column label="接收" show-overflow-tooltip min-width="50px">
          <template slot-scope="scope">
           <info-popover :userid="scope.row.receive" :avatar="scope.row.t_avatar"></info-popover>
          </template>
        </el-table-column>
        <el-table-column show-overflow-tooltip min-width="120px" label="昵称/ID">
          <template slot-scope="scope">
            ...
            <span title="用户ID">{{scope.row.receive}}</span>
          </template>
        </el-table-column>
        <!-- 用户信息结束 -->
