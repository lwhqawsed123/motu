  ...
  <div class="record">
    <div class="record-conter">
      ...
      >
        ...
        <el-table-column prop="credittype" min-width="50px" label="币种">
          <template slot-scope="scope">{{myFilter(scope.row.credittype,creditTypeOptions)}}</template>
        </el-table-column>
        <el-table-column prop="number" min-width="50px" label="数量"></el-table-column>
        <el-table-column prop="count" min-width="50px" label="余额"></el-table-column>
        <el-table-column prop="description" min-width="100px" label="描述"></el-table-column>
        <el-table-column prop="ipaddr" min-width="50px" label="IP"></el-table-column>
        <el-table-column prop="operator" min-width="50px" label="操作人"></el-table-column>
        <el-table-column prop="dateline" min-width="65px" label="操作时间">
          <template slot-scope="scope">{{parseTime(scope.row.dateline)}}</template>
        </el-table-column>
        <el-table-column show-overflow-tooltip label="操作" min-width="80px">
