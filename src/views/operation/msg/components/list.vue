...
export default {
  ...
  methods: {
    ...
    // 清除表格多选
    handClearSelection(){
      this.$refs.table.handClearSelection()
    },
    // 关闭修改弹框
